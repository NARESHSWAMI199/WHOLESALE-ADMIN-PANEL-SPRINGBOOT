package sales.application.sales.testglobal;
...
public class GlobalConstantTest {
    ...
    public static String STAFF_TEST_PASSWORD= "123456"; // You need provide your staff's account password for test


    public static String SUPER_ADMIN_TEST_EMAIL = "naresh@gmail.com"; // You need to provide your super admin account email
